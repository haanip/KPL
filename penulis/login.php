    ...
    <main>
      <div class="container-fluid">
        ...
        <div class="container-fluid mt-4 text-mattBlackDark" style="max-width: 400px;">
          <div class="card">
            <div class="card-header text-center bg-info" style="font-weight: bold; font-size: 20px; padding: 15px 0; color: white;">Penulis Login</div>
            <div class="card-body">
              <form method="POST" autocomplete="on" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                ...
                <br>
                <button type="submit" class="btn btn-info btn-block" name="submit" value="submit" style="border-radius: 50px;">Login</button>
                <div class="error text-center mt-3" style="color: red; font-size: 0.75em;"><?php if (isset($error_login)) echo $error_login; ?></div>
				
				<br>
				<h5 align="center" style="color=black; font-size: 0.75em">Don't have an account?</h5>
                <a href="../penulis/register.php" class="btn btn-info btn-block" style="border-radius: 25px;">Register Here</a>
              </form>
            </div>
          </div>
        </div>
