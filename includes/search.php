        ...
        <br><h2>Article</h2>
				...
				<?php
					if(isset($_POST['submit'])){
						$_SESSION['search_session']=$_POST['keyword'];
						$keyword=$_SESSION['search_session'];
					} else{
						$keyword=['search_session'];
					}
					require_once('../lib/db_login.php');
					$query = "SELECT post.* FROM post JOIN penulis ON post.idpenulis=penulis.idpenulis WHERE judul LIKE '%$keyword%' OR isi_post LIKE '%$keyword%' ORDER BY idpost ASC";
